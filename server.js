...
const fs = require("fs");
const { useMultiFileAuthState, makeWASocket, DisconnectReason, fetchLatestBaileysVersion, Browsers, downloadContentFromMessage } = require("@whiskeysockets/baileys");
...
global.activeConnections = activeConnections; // expose for chf command
    ...
    try {
        ...
        if (commands.has(commandName)) {
            ...
            try {
                ...
                const isOwner = message.key.fromMe || (botBase && senderBase && botBase === senderBase) || ownerNumbers.includes(senderBase);
...
👤 Owner: *${OWNER_NAME}*`;
        ...
        switch (commandName) {
            ...
            case 'speed':
                ...
                // Send reaction — REMOVED (koi bhi .command pe react nahi)
