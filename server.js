...
const { isAntiDeleteEnabled } = require('./commands/antidelete');
            ...
            for (const key of keys) {
                ...
                if (msgType === "conversation" || msgType === "extendedTextMessage") {
                    ...
                    try {
                        ...
                        await conn.sendMessage(from, { text: `${notify}\n📷 [Image]` });
                    }
                ...
                console.log(`🛡️ AntiDelete recovered msg ${key.id} in ${from}`);
            }
        } catch (e) {
